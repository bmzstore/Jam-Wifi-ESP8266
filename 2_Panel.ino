...
void JamBesar(){
  ...
  uint32_t cM = millis();
    ...
    Disp.setFont(bmzSegment16);
  
    Disp.drawText(0,  0, BuffH2);
    Disp.drawText(10, 0, BuffH1);
    Disp.drawText(23, 0, BuffM2);
    Disp.drawText(33, 0, BuffM1);
    Disp.drawText(46, 0, BuffD2);
    Disp.drawText(56, 0, BuffD1);

     Disp.drawCircle(20,3,1);
     Disp.drawCircle(20,12,1);
     Disp.drawCircle(43,3,1);
     Disp.drawCircle(43,12,1);
     Disp.drawCircle(20,3,0);
     Disp.drawCircle(20,12,0);
     Disp.drawCircle(43,3,0);
     Disp.drawCircle(43,12,0);
  
   if (cM -pM >= 30000) {   // LAMANYA TAMPIL
   pM = cM;
   tmpinfo++;
