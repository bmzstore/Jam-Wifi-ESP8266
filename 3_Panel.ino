...
void JamBesar(){
  ...
  uint32_t cM = millis();
    ...
    int s1,s2,m1,m2,h1,h2;
     s1 = now.Second() % 10/1;        
     s2 = now.Second() % 100/10;        
     m1 = now.Minute() % 10/1;
     m2 = now.Minute() % 100/10;
     h1 = now.Hour()   % 10/1;
     h2 = now.Hour()   % 100/10;
    ...
    Disp.setFont(BIG7SEGMENT);
  
    Disp.drawText(4,  0, BuffH2);
    Disp.drawText(16, 0, BuffH1);
    Disp.drawText(37, 0, BuffM2);
    Disp.drawText(49, 0, BuffM1);
    Disp.drawText(70, 0, BuffD2);
    Disp.drawText(82, 0, BuffD1);

    Disp.drawCircle(31,3,2);
    Disp.drawCircle(31,12,2);
    Disp.drawCircle(64,3,2);
    Disp.drawCircle(64,12,2);
    Disp.drawCircle(31,3,1);
    Disp.drawCircle(31,12,1);
    Disp.drawCircle(64,3,1);
    Disp.drawCircle(64,12,1);
    Disp.drawCircle(31,3,0);
    Disp.drawCircle(31,12,0);
    Disp.drawCircle(64,3,0);
    Disp.drawCircle(64,12,0);
...
void JamKecil() {
  ...
  sprintf(suhu, "%02d", celcius-koreksisuhu);
  if (cM - pMJam >= 1000) {
    pMJam = cM ;
   ...
   Disp.setFont(bmz6x7);
   Disp.drawText(6,-1, jam);
   Disp.setFont(bmz5x7);
   Disp.drawText(70,0, suhu);
   Disp.drawCircle(83,1,1);
   Disp.drawText(86,0, "C");
...
void TampilHariTanggal(){
  ...
  sprintf(tanggal, "HARI %s %02d %s %02d", weekDay[now.DayOfWeek()], now.Day(), monthYear[now.Month()], now.Year(), celcius - koreksisuhu);
